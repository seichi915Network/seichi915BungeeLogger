...
ThisBuild / description := "BungeeCordからのメッセージをPaperMCのコンソールにロギングするやつ"
...
lazy val root = (project in file("."))
  .settings(
    name := "seichi915BungeeLogger",
    assemblyOutputPath in assembly := baseDirectory.value / "target" / "build" / s"seichi915BungeeLogger-${version.value}.jar"
  )